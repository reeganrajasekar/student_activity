    ...
    <div class="modal fade" id="myModal">
        <div class="modal-dialog">
            ...
            <div class="modal-header">
                <h4 class="modal-title" style="color:rgba(106, 17, 203, 1)">Add Student</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>

            <!-- Modal body -->
            <div class="modal-body">
                <form onsubmit="document.getElementById('loader').style.display='block'" action="/admin/action/student.php" method="post">

...
<main class="container">
    ...
    <hr>
    <form action="/admin/staff.php" method="GET"><p style="text-align:right">Search : <input name="sid" style="height:35px;border:1px solid #ddd;border-radius:5px;padding-left:5px" type="text" name="sid" placeholder="Staff ID"> <button class="btn btn-secondary">Search</button></p></form>
    <hr>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                <form onsubmit="document.getElementById('loader').style.display='block'" action="/admin/action/staff.php" method="post">
                    ...
                    <div class="form-floating mb-3 mt-3">
                        <input required type="password" class="form-control"  name="passwd" placeholder="n">
    ...
    <table class="table table-striped table-bordered ">
        ...
        <tbody>
            ...
            if (isset($_GET["sid"])) {
                $sql = "SELECT * FROM staff where sid = '$sid' order by id DESC LIMIT " . $page_first_result . ',' . $results_per_page;
            }else{
                $sql = "SELECT * FROM staff order by id DESC LIMIT " . $page_first_result . ',' . $results_per_page;
            }
                ...
                <div class="modal-dialog modal-dialog-scrollable">
                    ...
                    <div class="modal-body">
                        <p style="color:#444;font-size:16px">
                            <span style="color:#888">Staff ID : </span><?php echo($row["sid"]) ?><br>
                        ...
                        ?>
                                <div class="col-md-4 border" style="padding:8px"><?php echo($row1["title"])?></div>
                                <div class="col-md-2 border" style="padding:8px"><?php echo($row1["cat"])?></div>
                                <div class="col-md-2 border" style="padding:8px"><script>document.write(moment('<?php echo ($row1["date"]) ?>').format('ll'))</script></div>
                                <div class="col-md-2 border" style="padding:8px"><a href="/static/uploads/<?php echo($row1["file"])?>" target="blank">Open File</a></div>
                                <div class="col-md-2 border" style="padding:8px">
            ...
            <tr>
                <td colspan=7 style="text-align:center">No Staff Details found !</td>
            </tr>

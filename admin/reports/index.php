...
<head>
    ...
    <title><?php echo($year.'-Year Students '.$cat.' report ('.$start.' to '.$end.')')?></title>
            ...
            while ($row1 = $result1->fetch_assoc()) {
                ...
                <section class="row border rounded p-3 mb-3">
                    ...
                    <div class="col-11 row">
                        ...
                        <span class="col-7" style="color:#000;font-weight:600"><span style="color:gray">Department & Year :</span> <?php echo($row1["dept"]) ?> & <?php echo($row1["year"]) ?></span>
                        <?php
                if($cat=="All"){
